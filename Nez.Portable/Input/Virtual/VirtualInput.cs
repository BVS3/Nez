...
namespace Nez
{
	...
	public abstract class VirtualInput
	{
		...
		/// </summary>
		public List<GuardDelegate> Guards = new List<GuardDelegate>();
		...
		//THIS DOES NOT WORK - CANNOT BE ASSUREED THAT OTHER BUTTONS WILL NOT READ THE INPUT PRIOR TO THIS UPDATE
		/// <summary>
